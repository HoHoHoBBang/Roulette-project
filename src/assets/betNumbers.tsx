...
export const dozenLine = [first12, second12, third12];
export const lowHighLine = [
  oneTo18,
  evenNum,
  redNum,
  blackNum,
...
export const combinedLine: lineNumberTypes[] = [
...
export const firstLine: lineNumberTypes[] = [];
export const secondLine: lineNumberTypes[] = [];
export const thirdLine: lineNumberTypes[] = [];
export const forthLine: lineNumberTypes[] = [];
export const fifthLine: lineNumberTypes[] = [];
export const sixthLine: lineNumberTypes[] = [];
export const splitLine: lineNumberTypes[][] = [];

for (let i = 5; i < 144; i += 6) {
  firstLine.push(combinedLine[i]);
}
for (let i = 4; i < 144; i += 6) {
  secondLine.push(combinedLine[i]);
}
for (let i = 3; i < 144; i += 6) {
  thirdLine.push(combinedLine[i]);
}
for (let i = 2; i < 144; i += 6) {
  forthLine.push(combinedLine[i]);
}
for (let i = 1; i < 144; i += 6) {
  fifthLine.push(combinedLine[i]);
}
for (let i = 0; i < 144; i += 6) {
  sixthLine.push(combinedLine[i]);
}
for (let i = 0; i < 144; i += 6) {
  splitLine.push(combinedLine.slice(i, i + 6));
}
